...
class linear_view final : private mizuiro::image::format::base<Format>
{
...
public:
  ...
  using iterator = mizuiro::image::linear_iterator<access, format, constness>;
  ...
  explicit linear_view(mizuiro::image::linear_view<access, format, OtherConstness> const &);
