...
#include <mizuiro/image/basic_iterator_decl.hpp> // IWYU pragma: export
...
template <typename Impl>
mizuiro::image::basic_iterator<Impl> &mizuiro::image::basic_iterator<Impl>::operator++()
{
  this->increment();
...
template <typename Impl>
bool mizuiro::image::basic_iterator<Impl>::operator==(basic_iterator const &_other) const
{
...
mizuiro::image::basic_iterator<Impl>::operator+=(difference_type const _diff)
{
  this->advance(_diff);
...
template <typename Impl>
bool mizuiro::image::operator!=(
    mizuiro::image::basic_iterator<Impl> const &_left,
    mizuiro::image::basic_iterator<Impl> const &_right)
{
  return !(_left == _right);
}
...
template <typename Impl>
mizuiro::image::basic_iterator<Impl>
mizuiro::image::operator++(mizuiro::image::basic_iterator<Impl> &_it, int)
{
  mizuiro::image::basic_iterator<Impl> temp{_it};
