...
inline void
prepare_store_units(mizuiro::image::format::store<ImageFormat> const &_format, Dest &_dest)
{
  static_assert(mizuiro::access::is<Access>::value, "Invalid Access type");

  mizuiro::image::detail::prepare_store_units<Access, ImageFormat>(_format, _dest);
}
