...
{
  static_assert(
      mizuiro::image::algorithm::can_copy<ViewS, ViewD>::value, "Views must be compatible");

  mizuiro::image::algorithm::detail::copy_impl(_src, _dest, _overlap, _uninitialized);
}
