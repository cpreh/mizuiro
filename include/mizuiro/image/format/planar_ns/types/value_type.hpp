...
mizuiro::color::object<typename ImageFormat::color_format::base> value_type_adl(
    mizuiro::image::types::value_type_ns::tag, mizuiro::image::format::planar_ns::tag<ImageFormat>);
