...
#ifndef MIZUIRO_IMAGE_FORMAT_PLANAR_NS_ACCESS_STRIDE_HPP_INCLUDED
#define MIZUIRO_IMAGE_FORMAT_PLANAR_NS_ACCESS_STRIDE_HPP_INCLUDED
...
{
  return mizuiro::access::stride<
      mizuiro::integral_size<1U>,
