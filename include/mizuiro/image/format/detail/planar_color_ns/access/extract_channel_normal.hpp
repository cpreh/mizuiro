...
#ifndef MIZUIRO_IMAGE_FORMAT_DETAIL_PLANAR_COLOR_NS_ACCESS_EXTRACT_CHANNEL_NORMAL_HPP_INCLUDED
#define MIZUIRO_IMAGE_FORMAT_DETAIL_PLANAR_COLOR_NS_ACCESS_EXTRACT_CHANNEL_NORMAL_HPP_INCLUDED
...
mizuiro::color::types::channel_reference<mizuiro::access::normal, Format, Channel, Constness>
extract_channel_adl(
...
{
  return *_data.get_unsafe(mizuiro::color::access::channel_index<Format>(_format, _channel));
}
