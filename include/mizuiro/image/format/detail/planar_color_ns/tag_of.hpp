...
struct tag_of<mizuiro::image::format::detail::planar_color<Format>>
{
  using type = mizuiro::image::format::detail::planar_color_ns::tag<
      mizuiro::image::format::detail::planar_color<Format>>;
};
