...
struct tag_of<mizuiro::image::format::interleaved<DimType, ColorFormat>>
{
  using type = mizuiro::image::format::interleaved_ns::tag<
      mizuiro::image::format::interleaved<DimType, ColorFormat>>;
};
