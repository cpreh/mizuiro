...
class planar final : private mizuiro::color::format::base<
                         mizuiro::image::format::detail::planar_color<ColorFormat>>
{
  using format_base =
      mizuiro::color::format::base<mizuiro::image::format::detail::planar_color<ColorFormat>>;
...
public:
  ...
  static mizuiro::size_type const element_count = ColorFormat::element_count;
