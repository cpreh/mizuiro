...
#ifndef MIZUIRO_COLOR_FORMAT_DYNAMIC_NS_TYPES_NEEDS_FORMAT_STORE_HPP_INCLUDED
#define MIZUIRO_COLOR_FORMAT_DYNAMIC_NS_TYPES_NEEDS_FORMAT_STORE_HPP_INCLUDED
...
std::true_type needs_format_store_adl(
