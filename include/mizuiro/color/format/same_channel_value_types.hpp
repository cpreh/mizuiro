...
using same_channel_value_types = fcppt::mpl::list::all_of<
    mizuiro::color::types::static_channels<Format1>,
    fcppt::mpl::bind<
        fcppt::mpl::lambda<mizuiro::color::format::detail::same_channel_value_type>,
        fcppt::mpl::constant<Format1>,
        fcppt::mpl::constant<Format2>,
        fcppt::mpl::arg<1>>>;
