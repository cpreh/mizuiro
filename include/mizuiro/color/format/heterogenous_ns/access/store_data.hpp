...
#ifndef MIZUIRO_COLOR_FORMAT_HETEROGENOUS_NS_ACCESS_STORE_DATA_HPP_INCLUDED
#define MIZUIRO_COLOR_FORMAT_HETEROGENOUS_NS_ACCESS_STORE_DATA_HPP_INCLUDED
...
#include <mizuiro/color/format/heterogenous_ns/types/pointer.hpp> // IWYU pragma: keep
