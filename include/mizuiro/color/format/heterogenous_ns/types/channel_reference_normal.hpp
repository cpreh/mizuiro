...
#ifndef MIZUIRO_COLOR_FORMAT_HETEROGENOUS_NS_TYPES_CHANNEL_REFERENCE_NORMAL_HPP_INCLUDED
#define MIZUIRO_COLOR_FORMAT_HETEROGENOUS_NS_TYPES_CHANNEL_REFERENCE_NORMAL_HPP_INCLUDED
...
mizuiro::color::channel_proxy<
    mizuiro::color::types::pointer<mizuiro::access::normal, Format, Constness>,
    mizuiro::color::types::channel_value<Format, Channel>,
    mizuiro::color::detail::heterogenous::access_normal<Format, Channel>>
