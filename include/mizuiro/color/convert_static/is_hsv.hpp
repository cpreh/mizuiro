...
using is_hsv = std::conjunction<
    mizuiro::color::format::has_channel_static<Format, mizuiro::color::channel::hue>,
    mizuiro::color::format::has_channel_static<Format, mizuiro::color::channel::saturation>,
    mizuiro::color::format::has_channel_static<Format, mizuiro::color::channel::value>>;
