...
template <typename Format, typename Vector>
inline void assign_object(
    mizuiro::color::object<Format> &_object,
    mizuiro::color::init::detail::values<Vector> const &_init)
{
  using color_types = fcppt::mpl::list::from<Vector>;

  static_assert(
      fcppt::mpl::list::all_of<
          mizuiro::color::types::static_channels<Format>,
          fcppt::mpl::bind<
              fcppt::mpl::lambda<mizuiro::color::init::detail::contains_channel>,
              fcppt::mpl::constant<color_types>,
              fcppt::mpl::arg<1>>>::value,
      "Forgotten channel in initialization");

  static_assert(
      fcppt::mpl::list::distinct<fcppt::mpl::list::map<
          color_types,
          fcppt::mpl::lambda<mizuiro::color::init::detail::to_channel_type>>>::value,
      "Duplicate channel initialization");

  fcppt::algorithm::loop(
      _init.get(),
      [&_object](auto const &_value)
      { mizuiro::color::init::detail::set_channel(_object, _value); });
}
