...
{
protected:
  using format_store_type = mizuiro::detail::normal_format_store<Format, Copy>;

  explicit normal_format_base(format_store_type const &);

  format_store_type format_store_base() const;
